    ...
    return c.json(
      {
        ...
        data: {
          auth_url: `https://github.com/login/oauth/authorize?client_id=${process.env.GITHUB_CLIENT_ID}&scope=repo%20delete_repo`,
        },
      },
      200,
    )
  ...
  .post(
    ...
    async (c) => {
      ...
      try {
        ...
        const projectRoot = project.container.projectRoot
